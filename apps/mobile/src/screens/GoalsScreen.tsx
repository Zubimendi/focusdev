...
const styles = StyleSheet.create({
  ...
  goalCard: { backgroundColor: '#1c2421', padding: 20, borderRadius: 24, width: 240, marginRight: 16, borderWidth: 1, borderColor: 'rgba(70, 69, 84, 0.1)' },
  goalTitle: { fontSize: 16, fontFamily: 'Inter_700Bold', color: '#eef1f0', marginBottom: 12 },
  goalProgressContainer: { height: 6, backgroundColor: 'rgba(70, 69, 84, 0.2)', borderRadius: 3, overflow: 'hidden' },
  goalProgressBar: { height: '100%', backgroundColor: '#7eb8a8', borderRadius: 3 },
  ...
  emptyGoalText: { color: '#7eb8a8', fontSize: 12, fontFamily: 'Inter_600SemiBold', textAlign: 'center' },
  ...
  taskInfo: { flex: 1 },
  taskTitle: { fontSize: 16, fontFamily: 'Inter_700Bold', color: '#eef1f0', marginBottom: 4 },
  ...
  modalTitle: { fontSize: 24, fontFamily: 'Inter_900Black', color: '#eef1f0' },
  modalForm: { gap: 20 },
  inputLabel: { fontSize: 10, fontFamily: 'Inter_800ExtraBold', color: '#7eb8a8', letterSpacing: 1.5, marginBottom: 8, marginTop: 16 },
  input: { 
    backgroundColor: '#1c2421', 
    borderRadius: 16, 
    padding: 16, 
  ...
  pSelect: { flex: 1, padding: 12, borderRadius: 12, backgroundColor: '#1c2421', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(70, 69, 84, 0.2)' },
  pSelectActive: { backgroundColor: 'rgba(126, 184, 168, 0.15)', borderColor: '#7eb8a8' },
  pSelectText: { fontSize: 10, fontFamily: 'Inter_800ExtraBold', color: '#64748b' },
  pSelectTextActive: { color: '#7eb8a8' },

  optionScroll: { paddingVertical: 8 },
  optionChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: '#1c2421', marginRight: 8, borderWidth: 1, borderColor: 'rgba(70, 69, 84, 0.2)' },
  optionChipActive: { backgroundColor: '#7eb8a8', borderColor: '#7eb8a8' },
