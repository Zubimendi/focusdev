        ...
        {activeTab === "Integrations" && (
          <section className="md:col-span-12 bg-surface-container-low rounded-2xl p-8 border border-outline-variant/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-surface-container-lowest p-8 rounded-2xl border border-primary/20 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="bg-primary hover:opacity-90 text-on-primary font-bold py-2.5 px-6 rounded-lg transition-all"
                >
                  Connect
                </button>
              </div>
