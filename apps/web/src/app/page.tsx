...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0e1322]">
      {/* Background Effects */}
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-8 py-20 flex flex-col items-center text-center">
        {/* Logo Badge */}
        <div className="mb-12 flex items-center gap-3 glass-panel px-6 py-3 rounded-2xl border border-outline-variant/10 shadow-2xl">
          ...
          <span className="text-2xl font-black text-white tracking-tighter">FocusDev</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <Link 
            href="/register"
            className="px-10 py-5 bg-primary text-on-primary font-bold text-lg rounded-2xl shadow-2xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all w-full sm:w-auto"
          >
            Get Started Free
          </Link>
          <Link 
            href="/login"
            className="px-10 py-5 glass-panel text-white font-bold text-lg rounded-2xl border border-outline-variant/20 hover:bg-surface-container-high transition-all w-full sm:w-auto"
          >
            Member Login
          </Link>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="p-8 glass-panel rounded-3xl border border-outline-variant/10">
            ...
            <p className="text-on-surface-variant text-sm">Advanced Pomodoro engine with custom work cycle analytics.</p>
          </div>
          <div className="p-8 glass-panel rounded-3xl border border-outline-variant/10">
            <span className="material-symbols-outlined text-secondary mb-4 text-3xl">fact_check</span>
            <h3 className="text-xl font-bold text-white mb-2">Daily Rituals</h3>
            <p className="text-on-surface-variant text-sm">Automated developer checklists to keep your sprint on track.</p>
          </div>
          <div className="p-8 glass-panel rounded-3xl border border-outline-variant/10">
            ...
            <p className="text-on-surface-variant text-sm">Visualize your LeetCode goals and technical growth milestones.</p>
          </div>
        </div>
      </main>

      {/* Footer Meta */}
      <footer className="absolute bottom-8 text-outline text-[10px] uppercase font-mono tracking-[0.4em] pointer-events-none">
